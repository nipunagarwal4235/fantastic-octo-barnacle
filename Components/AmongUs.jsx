    ...
    <>
      ...
      <section className="text-white font-poppins">
        <div className="max-w-screen-xl px-4 py-32 mx-auto lg:h-screen lg:items-center lg:flex">
          <div className="max-w-3xl h-4/6 mx-auto text-center">
            <h1 className="text-3xl font-poppins font-extrabold uppercase text-transparent tracking-widest sm:text-6xl bg-clip-text bg-gradient-to-r from-purple-300 via-purple-500 to-purple-700">
              It's an Experience.
            </h1>
            <div className="max-w-xl mx-auto mt-4 sm:leading-relaxed sm:text-xl">
